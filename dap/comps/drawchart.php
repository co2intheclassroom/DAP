...
<script type="text/javascript">
	...
	<div class="row justify-content-md-center">
		<div class="col col-lg-2">
		  <?php echo '<p><a class="btn btn-lg btn-primary" href="'.$_SERVER['PHP_SELF'].'?LocationID='.$querylocation.'&day='.$previousday.'" role="button">Previous Day</a></p>';?>
		...
		<div class="col col-lg-2">
			<?php if ($nextday < $today) {
				echo '<p><a class="btn btn-lg btn-primary" href="'.$_SERVER['PHP_SELF'].'?LocationID='.$querylocation.'&day='.$nextday.'" role="button">Next Date</a></p>';};
			?>
		</div>
